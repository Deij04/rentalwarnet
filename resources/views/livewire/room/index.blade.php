            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" wire:model.live="search"
                        ...
                        placeholder="Cari berdasarkan nama ruangan atau harga sewa..." />
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="table w-full">
                ...
                <tbody>
                    ...
                    <tr class="hover">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $room->Nama_ruangan }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $room->Harga_sewa }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            ...
                            <flux:button variant="danger" wire:click="delete({{ $room->id }})"
