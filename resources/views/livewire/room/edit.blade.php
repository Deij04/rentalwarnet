...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    #[Validate('required|numeric|min:0|max:99999999.99')] // Sesuai dengan decimal(10,2)
    public $harga_sewa;

    public function mount($id)
    {
        $this->room = Room::findOrFail($id);
        $this->nama_ruangan = $this->room->Nama_ruangan;
        $this->harga_sewa = $this->room->Harga_sewa;
    }
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-lg shadow p-6">
                ...
                <form wire:submit="update" class="space-y-6">
                    ...
                    <!-- Harga Sewa -->
                    <div>
                        <flux:input wire:model="harga_sewa" label="Harga Sewa" type="number" step="0.01" min="0" max="99999999.99" required
